...
res_AMI = Pi.get_SE_AMI_from_dispersion(iw, k_mesh)
print(res_AMI)
print('done')

CHI_random = CHI_AMI(beta, L, ord, 0, 0, os.getenv('GRAPH_PATH_calc_chi'), torch.device('cuda'),
